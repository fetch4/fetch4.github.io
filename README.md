...
A [GitHub workflow](https://github.com/fetch4/fetch4.github.io/blob/master/.github/workflows/hugo.yaml) is configured to automatically build and deploy the website to <https://fetch4.github.io/> whenever the `master` branch of this repo is updated.
